...
namespace TS4AlphaConverter
{
    public class LRLE
    {
        ...
        class ColorTable
        {
            ...
            //public int GetNearestColorIndex(byte[] color)
            //{
            //    uint tmp = BitConverter.ToUInt32(color, 0);
            //    int index = 0;
            //    if (pixelDict.TryGetValue(tmp, out index))
            //    {
            //        return index;
            //    }
            ...
            //                        if (d3 > 256) d3 = 256;
            //                        search[3] = (byte)d3;
            //                        tmp = BitConverter.ToUInt32(search, 0);
            //                        if (pixelDict.ContainsKey(tmp))
            //                        {
            //                            return pixelDict[tmp];
            //                        }
            //                    }
            //                }
            //            }
            ...
            //        if (searchDistance > 1)
            //        {
            //            return GetNearestColorIndexMultiarray(color, searchDistance);
            //        }
            //    }
            //    return 0;
            //}
            //public int GetNearestColorIndexLinear(byte[] color)
            //{
            //    int minDistance = int.MaxValue;
            //    int index = 0;
            //    for (int i = 0; i <pixelArray.Length; i++)
            //    {
            //        int distance = Math.Abs(color[0] - pixelArray[i][0]) + Math.Abs(color[1] - pixelArray[i][1]) + Math.Abs(color[2] - pixelArray[i][2]) + Math.Abs(color[3] - pixelArray[i][3]);
            //        if (distance <= 15) return i;
            ...
            //    return index;
            //}
            //public int GetNearestColorIndexMultiarray(byte[] color, int searchDistance)
            //{
            //    int ind0 = color[0] / factor;
            //    int ind1 = color[1] / factor;
            //    int ind2 = color[2] / factor;
            //    int ind3 = color[3] / factor;
            //    if (pixelMultiArray[ind0][ind1][ind2][ind3] > 0) return pixelMultiArray[ind0][ind1][ind2][ind3];
            ...
            //                        if (d3 < 0) d3 = 0;
            //                        if (d3 > tableDim - 1) d3 = tableDim - 1;
            //                        if (pixelMultiArray[d0][d1][d2][d3] >= 0)
            //                        {
            //                            done = true;
            //                            return pixelMultiArray[d0][d1][d2][d3];
            //                        }
            //                    }
            //                }
            //            }
